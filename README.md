...
- *test_joystick_lcd* - первый тест джойстика и экрана.
- *UTC_time_WiFi* - часы с получением времени от сервера реального времени.
- *WiFi_skaner_lcd* - сканер WiFi сетей с выдачей списка на экран.
- *rgb_led_WS2812B* - управление светодиодной лентой.
- *i2c_scanner* - сканер I2C-устройств
