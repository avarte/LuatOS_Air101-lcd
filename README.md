...
- [test_joystick_lcd](test_joystick_lcd) - первый тест джойстика и экрана.
- [UTC_time_WiFi](UTC_time_WiFi) - часы с получением времени от сервера реального времени.
- [WiFi_skaner_lcd](WiFi_skaner_lcd) - сканер WiFi сетей с выдачей списка на экран.
- [rgb_led_WS2812B](rgb_led_WS2812B) - управление светодиодной лентой.
- [i2c_scanner](i2c_scanner) - сканер I2C-устройств
- [aht10](aht10) - Чтение данных с датчика температуры и влажности AHT10
- [dht11](dht11) - Чтение данных с датчика температуры и влажности DHT11
